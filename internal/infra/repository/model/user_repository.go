...
type UserRepository interface {
	...
	GetIDByEmailOrCPF(ctx context.Context, email string, cpf string) (*uuid.UUID, string, error)
	GetUserByID(ctx context.Context, id uuid.UUID, withCompanies bool) (*User, error)
