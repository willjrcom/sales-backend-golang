...
type Service struct {
	...
	rp  *processusecases.Service
	rpr productentity.ProcessRuleRepository
	rq  *queueusecases.Service
}

func NewService(ro orderentity.OrderRepository, rs shiftentity.ShiftRepository, rgi *groupitemusecases.Service, rp *processusecases.Service, rpr productentity.ProcessRuleRepository, rq *queueusecases.Service) *Service {
